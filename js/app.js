...
*/
        ...
        const translation = {
            ...
            "hero-title": {
                ru: "Привет! Меня зовут Артём Петровский",
            ...
            "work-card-11-list-3": {
                ru: "Реализована логика корзины и страницы избранного",
                en: "Implemented cart and favourites pages logic"
            },
            "work-card-11-list-4": {
                ru: "Фильтрация по категориям, цене, рейтингу и поисковому запросу",
                en: "Filtration by categories, price, rating and search query"
            },
            "work-card-11-list-5": {
                ru: "Breadcrumbs и логика пагинации",
                en: "Breadcrumbs and pagination logic"
            },
            "work-card-11-list-6": {
                ru: "Прелоадер и skeleton анимация для карточек и страницы товара",
                en: "Preloader and skeleton animation for cards and page product"
            },
            "work-card-11-list-7": {
                ru: "Получение данных о товарах из бэкенда",
            ...
            "about-p-1": {
                ru: "Привет! Я Артём, фронтенд-разработчик.",
                en: "Hi there, I'm Artem, a passionate front-end developer."
            },
            "about-p-2": {
                ru: "Я отточил свои навыки в создании идеальных интерфейсов и воплощаю их в жизнь с помощью чистого, производительного кода. Я хорошо знаю HTML, CSS, SASS & SCSS, CSS-фреймворки (такие как Tailwind), JavaScript, TypeScript, React, Redux Toolkit, и мне нравится создавать интерактивные фишки, которые улучшают пользовательский опыт.",
            ...
            "about-p-3": {
                ru: "Посмотрите мои работы из портфолио, чтобы увидеть некоторые из недавних проектов. Я всегда готов учиться и сотрудничать, так что давайте общаться в Telegram или пишите мне на e-mail. До скорой связи!",
            ...
            "achievement-text-2": {
                ru: "в качестве эксперта по разработке превью макетов",
            ...
            "footer-copy": {
                ru: "© 2024 Вся информация, размещенная на этом сайте, является объектом авторского права. Копирование, использование или распространение информации без письменного разрешения правообладателя запрещено. Все товарные знаки, знаки обслуживания и логотипы, используемые на этом сайте, являются собственностью их владельцев.",
