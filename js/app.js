(() => {
    ...
    function colorToString(color, forceCSSHex) {
        ...
        if (forceCSSHex || "THREE_CHAR_HEX" === colorFormat || "SIX_CHAR_HEX" === colorFormat) {
            var str = color.hex.toString(16);
            while (str.length < 6) str = "0" + str;
            return "#" + str;
        } else if ("CSS_RGB" === colorFormat) return "rgb(" + r + "," + g + "," + b + ")"; else if ("CSS_RGBA" === colorFormat) return "rgba(" + r + "," + g + "," + b + "," + a + ")"; else if ("HEX" === colorFormat) return "0x" + color.hex.toString(16); else if ("RGB_ARRAY" === colorFormat) return "[" + r + "," + g + "," + b + "]"; else if ("RGBA_ARRAY" === colorFormat) return "[" + r + "," + g + "," + b + "," + a + "]"; else if ("RGB_OBJ" === colorFormat) return "{r:" + r + ",g:" + g + ",b:" + b + "}"; else if ("RGBA_OBJ" === colorFormat) return "{r:" + r + ",g:" + g + ",b:" + b + ",a:" + a + "}"; else if ("HSV_OBJ" === colorFormat) return "{h:" + h + ",s:" + s + ",v:" + v + "}"; else if ("HSVA_OBJ" === colorFormat) return "{h:" + h + ",s:" + s + ",v:" + v + ",a:" + a + "}";
    ...
    var Common = {
        ...
        each: function each(obj, itr, scope) {
            if (!obj) return;
            if (ARR_EACH && obj.forEach && obj.forEach === ARR_EACH) obj.forEach(itr, scope); else if (obj.length === obj.length + 0) {
                var key = void 0;
                var l = void 0;
    ...
    var INTERPRETATIONS = [ {
        ...
        conversions: {
            RGB_ARRAY: {
                read: function read(original) {
                    if (3 !== original.length) return false;
                    return {
                        space: "RGB",
                        r: original[0],
                        g: original[1],
            ...
            RGBA_ARRAY: {
                read: function read(original) {
                    if (4 !== original.length) return false;
                    return {
                        space: "RGB",
                        r: original[0],
                        g: original[1],
        ...
        Common.each(INTERPRETATIONS, (function(family) {
            if (family.litmus(original)) {
                Common.each(family.conversions, (function(conversion, conversionName) {
                    ...
                    if (false === toReturn && false !== result) {
                        toReturn = result;
    ...
    var ColorMath = {
        ...
        rgb_to_hsv: function rgb_to_hsv(r, g, b) {
            ...
            var h = void 0;
            var s = void 0;
            if (0 !== max) s = delta / max; else return {
                h: NaN,
                s: 0,
                v: 0
            };
    ...
    var get = function get(object, property, receiver) {
        ...
        if (void 0 === desc) {
            ...
            if (null === parent) return; else return get(parent, property, receiver);
    ...
    var Color = function() {
        function Color() {
            ...
            if (false === this.__state) throw new Error("Failed to interpret color arguments");
    ...
    function defineRGBComponent(target, component, componentHexIndex) {
        Object.defineProperty(target, component, {
            get: function get$$1() {
                if ("RGB" === this.__state.space) return this.__state[component];
    ...
    function defineHSVComponent(target, component) {
        Object.defineProperty(target, component, {
            get: function get$$1() {
                if ("HSV" === this.__state.space) return this.__state[component];
    ...
    Color.recalculateRGB = function(color, component, componentHexIndex) {
        if ("HEX" === color.__state.space) color.__state[component] = ColorMath.component_from_hex(color.__state.hex, componentHexIndex); else if ("HSV" === color.__state.space) Common.extend(color.__state, ColorMath.hsv_to_rgb(color.__state.h, color.__state.s, color.__state.v)); else throw new Error("Corrupted color state");
    };
    Color.recalculateHSV = function(color) {
        ...
        if (!Common.isNaN(result.h)) color.__state.h = result.h; else if (Common.isUndefined(color.__state.h)) color.__state.h = 0;
    };
    ...
    var dom = {
        makeSelectable: function makeSelectable(elem, selectable) {
            if (void 0 === elem || void 0 === elem.style) return;
        ...
        addClass: function addClass(elem, className) {
            if (void 0 === elem.className) elem.className = className; else if (elem.className !== className) {
        ...
        removeClass: function removeClass(elem, className) {
            if (className) if (elem.className === className) elem.removeAttribute("class"); else {
                var classes = elem.className.split(/ +/);
    ...
    var NumberController = function(_Controller) {
        ...
        function NumberController(object, property, params) {
            ...
            if (Common.isUndefined(_this.__step)) if (0 === _this.initialValue) _this.__impliedStep = 1; else _this.__impliedStep = Math.pow(10, Math.floor(Math.log(Math.abs(_this.initialValue)) / Math.LN10)) / 10; else _this.__impliedStep = _this.__step;
        ...
        createClass(NumberController, [ {
            ...
            value: function setValue(v) {
                var _v = v;
                if (void 0 !== this.__min && _v < this.__min) _v = this.__min; else if (void 0 !== this.__max && _v > this.__max) _v = this.__max;
                if (void 0 !== this.__step && _v % this.__step !== 0) _v = Math.round(_v / this.__step) * this.__step;
    ...
    var NumberControllerSlider = function(_NumberController) {
        ...
        createClass(NumberControllerSlider, [ {
            ...
            value: function updateDisplay() {
                ...
                this.__foreground.style.width = 100 * pct + "%";
    ...
    var FunctionController = function(_Controller) {
        ...
        function FunctionController(object, property, text) {
            ...
            _this2.__button.innerHTML = void 0 === text ? "Fire" : text;
    ...
    var ColorController = function(_Controller) {
        ...
        function ColorController(object, property) {
            ...
            dom.bind(_this2.__input, "keydown", (function(e) {
                if (13 === e.keyCode) onBlur.call(this);
            }));
            dom.bind(_this2.__input, "blur", onBlur);
            ...
            _this2.updateDisplay();
            function setSV(e) {
                if (-1 === e.type.indexOf("touch")) e.preventDefault();
    ...
    var GUI = function GUI(pars) {
        ...
        var useLocalStorage = SUPPORTS_LOCAL_STORAGE && "true" === localStorage.getItem(getLocalStorageHash(this, "isLocal"));
        ...
        Object.defineProperties(this, {
            ...
            preset: {
                ...
                set: function set$$1(v) {
                    if (_this.parent) _this.getRoot().preset = v; else params.load.preset = v;
            ...
            closed: {
                ...
                set: function set$$1(v) {
                    params.closed = v;
                    if (params.closed) dom.addClass(_this.__ul, GUI.CLASS_CLOSED); else dom.removeClass(_this.__ul, GUI.CLASS_CLOSED);
                    this.onResize();
            ...
            useLocalStorage: {
                ...
                set: function set$$1(bool) {
                    if (SUPPORTS_LOCAL_STORAGE) {
                        ...
                        if (bool) dom.bind(window, "unload", saveToLocalStorage); else dom.unbind(window, "unload", saveToLocalStorage);
        ...
        if (Common.isUndefined(params.parent)) {
            ...
            if (SUPPORTS_LOCAL_STORAGE) if (useLocalStorage) {
            ...
            if (void 0 === params.closed) params.closed = true;
        ...
        saveToLocalStorage = function saveToLocalStorage() {
            if (SUPPORTS_LOCAL_STORAGE && "true" === localStorage.getItem(getLocalStorageHash(_this, "isLocal"))) localStorage.setItem(getLocalStorageHash(_this, "gui"), JSON.stringify(_this.getSaveObject()));
        };
    ...
    GUI._keydownHandler = function(e) {
        if ("text" !== document.activeElement.type && (e.which === HIDE_KEY_CODE || e.keyCode === HIDE_KEY_CODE)) GUI.toggleHide();
    };
    ...
    Common.extend(GUI.prototype, {
        ...
        remember: function remember() {
            ...
            Common.each(Array.prototype.slice.call(arguments), (function(object) {
                if (0 === _this.__rememberedObjects.length) addSaveMenu(_this);
                if (-1 === _this.__rememberedObjects.indexOf(object)) _this.__rememberedObjects.push(object);
            }));
        ...
        revert: function revert(gui) {
            Common.each(this.__controllers, (function(controller) {
                if (!this.getRoot().load.remembered) controller.setValue(controller.initialValue); else recallSavedValue(gui || this.getRoot(), controller);
    ...
    function markPresetModified(gui, modified) {
        ...
        if (modified) opt.innerHTML = opt.value + "*"; else opt.innerHTML = opt.value;
    }
    ...
    function recallSavedValue(gui, controller) {
        ...
        if (-1 !== matchedIndex) {
            ...
            if (root.load && root.load.remembered) {
                ...
                var preset = void 0;
                if (presetMap[gui.preset]) preset = presetMap[gui.preset]; else if (presetMap[DEFAULT_DEFAULT_PRESET_NAME]) preset = presetMap[DEFAULT_DEFAULT_PRESET_NAME]; else return;
                if (preset[matchedIndex] && void 0 !== preset[matchedIndex][controller.property]) {
    ...
    function _add(gui, object, property, params) {
        ...
        if (controller instanceof ColorController) dom.addClass(li, "color"); else dom.addClass(li, _typeof(controller.getValue()));
    ...
    function addSaveMenu(gui) {
        ...
        if (SUPPORTS_LOCAL_STORAGE) {
            ...
            if ("true" === localStorage.getItem(getLocalStorageHash(gui, "isLocal"))) localStorageCheckBox.setAttribute("checked", "checked");
        ...
        dom.bind(newConstructorTextArea, "keydown", (function(e) {
            if (e.metaKey && (67 === e.which || 67 === e.keyCode)) SAVE_DIALOGUE.hide();
        }));
    ...
    function updateDisplays(controllerArray) {
        if (0 !== controllerArray.length) requestAnimationFrame$1.call(window, (function() {
    ...
    if (script_bg_isMobile()) config.DYE_RESOLUTION = 512;
    ...
    function getWebGLContext(canvas) {
        ...
        ga("send", "event", isWebGL2 ? "webgl2" : "webgl", null == formatRGBA ? "not supported" : "supported");
        return {
            gl,
            ext: {
                formatRGBA,
    ...
    function addKeywords(source, keywords) {
        if (null == keywords) return source;
        let keywordsString = "";
    ...
    function initFramebuffers() {
        ...
        if (null == dye) dye = createDoubleFBO(dyeRes.width, dyeRes.height, rgba.internalFormat, rgba.format, texType, filtering); else dye = resizeDoubleFBO(dye, dyeRes.width, dyeRes.height, rgba.internalFormat, rgba.format, texType, filtering);
        if (null == velocity) velocity = createDoubleFBO(simRes.width, simRes.height, rg.internalFormat, rg.format, texType, filtering); else velocity = resizeDoubleFBO(velocity, simRes.width, simRes.height, rg.internalFormat, rg.format, texType, filtering);
    ...
    function render(target) {
        ...
        if (config.SUNRAYS) {
            ...
            script_bg_blur(sunrays, sunraysTemp, 1);
        }
        if (null == target || !config.TRANSPARENT) {
            gl.blendFunc(gl.ONE, gl.ONE_MINUS_SRC_ALPHA);
            gl.enable(gl.BLEND);
        } else gl.disable(gl.BLEND);
        let width = null == target ? gl.drawingBufferWidth : target.width;
        let height = null == target ? gl.drawingBufferHeight : target.height;
        gl.viewport(0, 0, width, height);
        let fbo = null == target ? null : target.fbo;
        if (!config.TRANSPARENT) drawColor(fbo, normalizeColor(config.BACK_COLOR));
        if (null == target && config.TRANSPARENT) drawCheckerboard(fbo);
    ...
    function script_bg_blur(target, temp, iterations) {
        blurProgram.bind();
    ...
    function multipleSplats(amount) {
        for (let i = 0; i < amount; i++) {
            ...
            const x = Math.random();
            const y = Math.random();
            const dx = 1e3 * (Math.random() - .5);
            const dy = 1e3 * (Math.random() - .5);
    ...
    canvas.addEventListener("mouseover", (e => {
        ...
        let pointer = pointers.find((p => -1 == p.id));
        if (null == pointer) pointer = new pointerPrototype;
    ...
    window.addEventListener("touchend", (e => {
        ...
        for (let i = 0; i < touches.length; i++) {
            ...
            if (null == pointer) continue;
            updatePointerUpData(pointer);
        }
    }));
    window.addEventListener("keydown", (e => {
        if ("KeyP" === e.code) config.PAUSED = !config.PAUSED;
        if (" " === e.key) splatStack.push(parseInt(20 * Math.random()) + 5);
    }));
