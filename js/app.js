(() => {
    ...
    (() => {
        ...
        !function(e, t) {
            ...
            const n = e => Array.from(e), r = e => document.createTextNode(e);
            ...
            }, o = "data-typeit-id", s = "ti-cursor", l = {
                started: !1,
                completed: !1,
                frozen: !1,
                destroyed: !1
            ...
            function d(e, t = !1, n = !1) {
                ...
                for (;r = a.nextNode(); ) r.originalParent || (r.originalParent = r.parentNode), 
                o.push(r);
            ...
            const h = e => document.createElement(e), y = (e, t = "") => {
                let n = h("style");
                n.id = t, n.appendChild(r(e)), document.head.appendChild(n);
            }, p = t => (e(t) || (t = [ t / 2, t / 2 ]), t), m = (e, t) => Math.abs(Math.random() * (e + t - (e - t)) + (e - t));
            let g = e => e / 2;
            ...
            const S = (e, t) => new Array(t).fill(e), N = ({queueItems: e, selector: t, cursorPosition: n, to: r}) => {
                if (T(t)) return -1 * t;
                let i = new RegExp("END", "i").test(r), a = t ? [ ...e ].reverse().findIndex((({char: e}) => {
            ...
            })), C = e => e?.getAnimations().find((t => t.id === e.dataset.tiAnimationId)), D = ({cursor: e, frames: t, options: n}) => {
                let r = e.animate(t, n);
            ...
            }, I = e => e.func?.call(null), M = async ({index: e, queueItems: t, wait: n, cursor: r, cursorOptions: i}) => {
                let a = t[e][1], o = [], s = e, l = a, u = () => l && !l.delay, c = a.shouldPauseCursor() && i.autoPause;
            ...
            return function(e, r = {}) {
                ...
                }(Y)[e], $ = () => (e => b(e) ? n(e.value) : d(e, !0).filter((e => !(e.childNodes.length > 0))))(J), H = (e, t) => (ee.add(e), 
                ((e = {}) => {
                    let t = e.delay;
                    t && ee.add({
                        delay: t
                    ...
                    if (!x() && ne && J.appendChild(ne), te) {
                        ((e, t) => {
                            let n = `[${o}='${e}'] .${s}`, r = getComputedStyle(t), i = Object.entries(P).reduce(((e, [t, n]) => `${e} ${t}: var(--ti-cursor-${t}, ${n || r[t]});`), "");
                            y(`${n} { display: inline-block; width: 0; ${i} }`, e);
                        })(Z, J), ne.dataset.tiAnimationId = Z;
                        let {animation: e} = Y.cursor, {frames: t, options: n} = e;
                        D({
                            frames: t,
                            cursor: ne,
                            options: {
                ...
                this.break = function(e) {
                    ...
                    e = w(e);
                    let n = F(t), r = e, {instant: i, to: a} = t, o = ee.getTypeable(), s = null === r ? o.length : T(r) ? r : N({
                        queueItems: o,
                        selector: r,
                        cursorPosition: O(),
                        to: a
                    ...
                    e = w(e);
                    let n = F(t), {instant: r, to: i} = t, a = N({
                    ...
                    e = w(e);
                    let {instant: n} = t, r = F(t), i = f(e, Y.html).map((e => {
                        return {
                            func: () => _(e),
                            char: e,
                    ...
                    !this.is("destroyed") && this.destroy(), e ? (ee.wipe(), e(this)) : ee.reset(), 
                    X = 0;
                ...
                }, this.getQueue = () => ee, this.getOptions = () => Y, this.updateOptions = e => j(e), 
                this.getElement = () => J;
                let J = "string" == typeof (U = e) ? v(U) : U;
                var U;
                let W = [], X = 0, G = null, K = E({}, l);
                r.cursor = (e => {
                    if ("object" == typeof e) {
                        let t = {}, {frames: n, options: r} = u.cursor.animation;
                        return t.animation = e.animation || {}, t.animation.frames = e.animation?.frames || n, 
                        t.animation.options = E(r, e.animation?.options || {}), t.autoPause = e.autoPause ?? u.cursor.autoPause, 
                        t.autoPauseDelay = e.autoPauseDelay || u.cursor.autoPauseDelay, t;
                    }
                ...
                let Z = Math.random().toString().substring(2, 9), ee = function(e) {
                    let n = function(e) {
                    ...
                    }, e), i = () => Array.from(a.values()), a = new Map;
                    return n(e), {
                        add: n,
                        set: function(e, t) {
                            let n = [ ...a.keys() ];
                ...
                let te = !!Y.cursor && !x(), ne = (() => {
                    if (x()) return;
                    let e = h("span");
                    return e.className = s, te ? (e.innerHTML = a(Y.cursorChar).innerHTML, e) : (e.style.visibility = "hidden", 
                    e);
                })();
                Y.strings = (e => {
                    let t = J.innerHTML;
        ...
        const translation = {
            ...
            "hero-subtitle": {
                ru: "Я занимаюсь дизайном, версткой, разработкой сайтов и веб-приложений",
            ...
            "work-card-6-vpn": {
                ru: "может потребоваться VPN",
                en: "may require a VPN"
            },
            "work-card-5-title": {
                ru: 'Верстка лендинга для компании интегратора AmoCRM "WELBEX"',
                en: 'Landing page layout for a AmoCRM integrator company "WELBEX"'
            },
            "work-card-5-list-1": {
                ru: "Длинный лендинг с нестандартной сеткой расположения элементов",
            ...
            "work-card-4-title": {
                ru: 'Верстка лендинга для сантехнической компании "ТеплоДом"',
            ...
            "work-card-4-list-3": {
                ru: "Скрытие элеметов описания в спойлеры (аккордеон)",
                en: "Hiding elements of the description in spoilers (accordion)"
            },
            "work-card-4-list-4": {
                ru: "Слайдер изображений на карточках проектов",
            ...
            "work-card-3-title": {
                ru: 'Верстка главной страницы сайта изготовителя пельменей "Лень Пельмень"',
                en: 'Layout of the home-page of the dumplings manufacturer "Len Pelmen"'
            },
            "work-card-3-list-1": {
                ru: "Прелоадер до полной загрузки сайта",
            ...
            "work-card-3-list-4": {
                ru: "Анимированное движение изображения при скролле страницы",
            ...
            "work-card-2-title": {
                ru: 'Верстка лендинга для NFT маркетплейса "PsychoArt"',
            ...
            "work-card-2-list-4": {
                ru: "Табы переключения видов коллекций NFT",
            ...
            "work-card-1-title": {
                ru: 'Верстка главной страницы сайта для ветклиники "Айболит"',
            ...
            "work-card-1-list-4": {
                ru: 'Кнопки "Показать еще" и "Скрыть"',
        ...
        themeToggle.addEventListener("click", (function(e) {
            e.preventDefault();
            if ("light" === localStorage.getItem("theme")) localStorage.removeItem("theme"); else localStorage.setItem("theme", "light");
            addLightClassToTHML();
        }));
        ...
        function changeLang() {
            for (const key in translation) {
                ...
                if ("ru" === localStorage.getItem("lang")) elem.textContent = translation[key]["ru"]; else elem.textContent = translation[key]["en"];
            }
        }
        changeLang();
        ...
        langToogle.addEventListener("click", (function(e) {
            e.preventDefault();
            if ("ru" === localStorage.getItem("lang")) localStorage.removeItem("lang"); else localStorage.setItem("lang", "ru");
            addRuClassToTHML();
            changeLang();
        }));
        function addRuClassToTHML() {
            try {
                if ("ru" === localStorage.getItem("lang")) {
        ...
        if (!isMobile.any()) window.onpointermove = event => {
